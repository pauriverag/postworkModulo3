...
public class ClienteControllerTest {
    ...
    void getClientes() throws Exception {
        ...
        List<Cliente> clientes = Arrays.asList(
                ...
                Cliente.builder().id(2L).nombre("Nombre 2").direccion("Direccion 2").numeroEmpleados("20").correoContacto("contacto@cliente2.com").build(),
                Cliente.builder().id(3L).nombre("Nombre 3").direccion("Direccion 3").numeroEmpleados("30").correoContacto("contacto@cliente3.com").build()
        );
